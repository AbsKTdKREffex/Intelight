...
/**
 * Servlet implementation class GetElectricianCompanyList
 */
@WebServlet("/GetElectricianCompanyList")
public class GetElectricianCompanyList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String sql = "SELECT * FROM maroo_data.detailedcontractor";
