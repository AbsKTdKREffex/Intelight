...
/**
 * Servlet implementation class ContactPUpdateServlet
 */
@WebServlet("/ContactPUpdateServlet")
public class ClientContactPUpdateServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		cntp.setContactPersonId(request.getParameter("selectedContctPId"));
