...
/**
 * Servlet implementation class GetSpecificList
 */
@WebServlet("/GetSpecificArchitectList")
public class GetSpecificArchitectList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    String sql = "SELECT * FROM maroo_data.companylist where rowId='"+request.getParameter("companyId")+"';";
