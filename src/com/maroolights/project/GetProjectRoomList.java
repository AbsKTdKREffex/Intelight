 ...
 */
@WebServlet("/GetProjectRoomList")
public class GetProjectRoomList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    */
	    String sql = "SELECT * FROM maroo_data.allroomlist where projectId = '"+request.getParameter("selectedProjectId")+"';";
