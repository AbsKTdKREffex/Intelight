...
public class GetProjectDetails extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    */
	    String sql = "SELECT * FROM maroo_data.allprojectlistmain where rowid = '"+ request.getParameter("selectedProjectId") +"';";
		...
		try
		{
			...
			while (rs.next()) {
				 ...
				 arrayObj.put("electricianNo", rs.getString("electricianNo")==null?"":rs.getString("electricianNo"));
				 arrayObj.put("contractorElectrician", rs.getString("contractorElectrician")==null?"":rs.getString("contractorElectrician"));
				 arrayObj.put("contractorElectricianNo", rs.getString("contractorElectricianNo")==null?"":rs.getString("contractorElectricianNo"));
				 ...
				 arrayObj.put("projectManagerID", rs.getString("projectManager")==null?"":rs.getString("projectManager"));
				 arrayObj.put("siteTiming", rs.getString("siteTiming")==null?"":rs.getString("siteTiming"));
				 ...
				 arrayObj.put("projcategory_Desc", rs.getString("projcategory_Desc")==null?"":rs.getString("projcategory_Desc"));
				 arrayObj.put("projsubcategory_Desc", rs.getString("projsubcategory_Desc")==null?"":rs.getString("projsubcategory_Desc"));
